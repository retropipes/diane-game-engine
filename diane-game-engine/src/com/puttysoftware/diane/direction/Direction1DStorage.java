...
public class Direction1DStorage {
     ...
     */
    public Direction1DStorage(final int... shape) {
	...
	this.dataStore = new Direction1D[product];
    }
     ...
     * @param shape  simulated dimensions for the stored data
     */
    protected Direction1DStorage(final Direction1D[] source, final int... shape) {
	this.dataShape = shape;
	this.interProd = new int[this.dataShape.length];
	var product = 1;
	for (var x = 0; x < this.dataShape.length; x++) {
     ...
     */
    public Direction1DStorage(final Direction1DStorage source) {
     ...
     * Check for equality.
     *
     * @param obj the other Direction to check
	...
	if (obj == null || !(obj instanceof final Direction1DStorage other)
     ...
     */
    public final void fill(final Direction1D obj) {
     ...
     */
    public final Direction1D getCell(final int... loc) {
     ...
     */
    protected final Direction1D getRawCell(final int rawLoc) {
     ...
     */
    public final void setCell(final Direction1D obj, final int... loc) {
	final var aloc = this.ravelLocation(loc);
     ...
     */
    protected final void setRawCell(final Direction1D obj, final int rawLoc) {
