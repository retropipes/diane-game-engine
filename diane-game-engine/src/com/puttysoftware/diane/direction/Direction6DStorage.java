...
public class Direction6DStorage {
     ...
     */
    public Direction6DStorage(final int... shape) {
	...
	this.dataStore = new Direction6D[product];
    }
     ...
     * @param shape  simulated dimensions for the stored data
     */
    protected Direction6DStorage(final Direction6D[] source, final int... shape) {
	this.dataShape = shape;
	this.interProd = new int[this.dataShape.length];
	var product = 1;
	for (var x = 0; x < this.dataShape.length; x++) {
     ...
     */
    public Direction6DStorage(final Direction6DStorage source) {
	...
	if (obj == null || !(obj instanceof final Direction6DStorage other)
     ...
     */
    public final void fill(final Direction6D obj) {
     ...
     */
    public final Direction6D getCell(final int... loc) {
     ...
     */
    protected final Direction6D getRawCell(final int rawLoc) {
     ...
     */
    public final void setCell(final Direction6D obj, final int... loc) {
	final var aloc = this.ravelLocation(loc);
     ...
     */
    protected final void setRawCell(final Direction6D obj, final int rawLoc) {
