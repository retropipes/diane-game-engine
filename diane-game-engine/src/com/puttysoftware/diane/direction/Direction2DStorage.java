...
public class Direction2DStorage {
     ...
     */
    public Direction2DStorage(final int... shape) {
	...
	this.dataStore = new Direction2D[product];
    }
     ...
     * @param shape  simulated dimensions for the stored data
     */
    protected Direction2DStorage(final Direction2D[] source, final int... shape) {
	this.dataShape = shape;
	this.interProd = new int[this.dataShape.length];
	var product = 1;
	for (var x = 0; x < this.dataShape.length; x++) {
     ...
     */
    public Direction2DStorage(final Direction2DStorage source) {
     ...
     * Check for equality.
     *
     * @param obj the other Direction2D to check
	...
	if (obj == null || !(obj instanceof final Direction2DStorage other)
     ...
     */
    public final void fill(final Direction2D obj) {
     ...
     */
    public final Direction2D getCell(final int... loc) {
     ...
     */
    protected final Direction2D getRawCell(final int rawLoc) {
     ...
     */
    public final void setCell(final Direction2D obj, final int... loc) {
	final var aloc = this.ravelLocation(loc);
     ...
     */
    protected final void setRawCell(final Direction2D obj, final int rawLoc) {
