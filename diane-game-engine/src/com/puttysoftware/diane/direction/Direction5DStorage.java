...
public class Direction5DStorage {
     ...
     */
    public Direction5DStorage(final int... shape) {
	...
	this.dataStore = new Direction5D[product];
    }
     ...
     * @param shape  simulated dimensions for the stored data
     */
    protected Direction5DStorage(final Direction5D[] source, final int... shape) {
	this.dataShape = shape;
	this.interProd = new int[this.dataShape.length];
	var product = 1;
	for (var x = 0; x < this.dataShape.length; x++) {
     ...
     */
    public Direction5DStorage(final Direction5DStorage source) {
     ...
     * Check for equality.
     *
     * @param obj the other Direction5D to check
	...
	if (obj == null || !(obj instanceof final Direction5DStorage other)
     ...
     */
    public final void fill(final Direction5D obj) {
     ...
     */
    public final Direction5D getCell(final int... loc) {
     ...
     */
    protected final Direction5D getRawCell(final int rawLoc) {
     ...
     */
    public final void setCell(final Direction5D obj, final int... loc) {
	final var aloc = this.ravelLocation(loc);
     ...
     */
    protected final void setRawCell(final Direction5D obj, final int rawLoc) {
