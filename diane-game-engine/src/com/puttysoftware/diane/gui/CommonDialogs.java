...
public class CommonDialogs {
  ...
  public static void showDialog(final String msg) {
    JOptionPane.showMessageDialog(MainWindow.owner(), msg,
        CommonDialogs.DEFAULT_TITLE, JOptionPane.INFORMATION_MESSAGE,
        CommonDialogs.ICON);
  }
  ...
  public static String showInputDialog(final String prompt, final String title,
    ...
    return (String) JOptionPane.showInputDialog(MainWindow.owner(), prompt,
        title, JOptionPane.QUESTION_MESSAGE, CommonDialogs.ICON, choices,
        defaultChoice);
  }
  ...
  public static String showTextInputDialog(final String prompt,
      final String title) {
    return (String) JOptionPane.showInputDialog(MainWindow.owner(), prompt,
        title, JOptionPane.QUESTION_MESSAGE, CommonDialogs.ICON, null, null);
  }
  ...
  public static char[] showPasswordInputDialog(final String prompt,
    ...
    panel.add(label);
    panel.add(pass);
    final int option = JOptionPane.showOptionDialog(MainWindow.owner(), panel,
  ...
  public static String showTextInputDialogWithDefault(final String prompt,
    ...
    return (String) JOptionPane.showInputDialog(MainWindow.owner(), prompt,
        title, JOptionPane.QUESTION_MESSAGE, CommonDialogs.ICON, null,
        defaultValue);
  }
  ...
  public static int showConfirmDialog(final String prompt, final String title) {
    return JOptionPane.showConfirmDialog(MainWindow.owner(), prompt, title,
  ...
  public static int showCustomDialog(final String prompt, final String title,
    ...
    return JOptionPane.showOptionDialog(MainWindow.owner(), prompt, title,
        JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE,
        CommonDialogs.ICON, buttonNames, defaultButton);
  }
