...
public abstract class GameObject implements ObjectModel {
  ...
  @Override
  public final GameImage getEditorImage() {
    return this.getEditorImageHook();
  }

  @Override
  public final GameImage getBattleImage() {
    return this.getBattleImageHook();
  }

  protected GameImage getImageHook() {
    if (this.tile != null) {
  ...
  protected GameImage getGameImageHook() {
    if (this.tile != null) {
  ...
  protected GameImage getEditorImageHook() {
    if (this.tile != null) {
  ...
  protected GameImage getBattleImageHook() {
    if (this.tile != null) {
