...
public class CommonDialogs {
  ...
  public static String showTextInputDialogWithDefault(final String prompt,
    ...
    return (String) JOptionPane.showInputDialog(null, prompt, title,
        JOptionPane.QUESTION_MESSAGE, CommonDialogs.ICON, null, defaultValue);
  }
   ...
   *          The image to use.
   */
  public static void setIcon(final GameImage icon) {
    CommonDialogs.ICON = new BufferedImageIcon(icon);
  }
}
