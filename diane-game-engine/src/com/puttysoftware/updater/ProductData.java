...
public class ProductData {
  ...
  public ProductData(final String update, final String blurb,
      final String newVersion, final String companyMac, final String company,
      final String product, final int major, final int minor, final int bugfix,
    ...
    try {
      this.blurbURL = new URL(blurb + rt_url + blurbtxt);
    } catch (final MalformedURLException mu1) {
      // Ignore
    }
    try {
